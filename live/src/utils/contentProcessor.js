...
const keywordMappings = {
  ...
  'padlófûtés aljzat': 'padlofutes-aljzat-budapest',
  'padlófûtéses aljzat': 'padlofutes-aljzat-budapest',
  
  // Speciális betonok
  'speciális betonozás': 'specialis-betonozas-budapest',
  'gyorskötõ beton': 'gyorskoto-beton-budapest',
  'gyorskötõ': 'gyorskoto-beton-budapest',
  'könnyûbeton': 'konnyubeton-budapest',
  'könnyû beton': 'konnyubeton-budapest',
  ...
  'minõségbiztosítás': 'minosegbiztositas',
...
// Ellenõrzi, hogy egy szó már linkelt-e ebben a bekezdésben
  ...
  return paragraphs.map(paragraph => {
    ...
    for (const keyword of sortedKeywords) {
      ...
      if (regex.test(processedParagraph)) {
        ...
        // Csak az elsõ elõfordulást cseréljük le
